...
### Encryption
```
spring-crypto-cli encrypt --message "Hello" --key "test" [--mode "GCM"]
```
...
### Decryption
```
spring-crypto-cli decrypt --message "6d3de18155ea5faa717ecd34e9443d3f73867664fc8977829c4382c4878fcf1c" --key "test" [--mode "GCM"]
```
returns:
```
Hello
